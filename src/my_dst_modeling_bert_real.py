...
from transformers.modeling_bert import BertEncoder, BertPreTrainedModel, BertConfig
...
class BertPooler(nn.Module):
    ...
    def forward(self, cls_token_tensor):
...
class BERTForDST(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.dropout_gate = nn.Dropout(config.hidden_dropout_prob)
        ...
        self.dropout_slot = nn.Dropout(config.hidden_dropout_prob)
    ...
    def resize_positional_embeddings(self, new_max_position_length:int):
        old_position_embeddings = self.bert.embeddings.position_embeddings
